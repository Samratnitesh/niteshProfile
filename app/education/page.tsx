  ...
  return (
    <>
      <PageHeader className="mb-10">
        ...
        From classroom basics to production-ready code
        </PageHeaderHeading>
        <PageHeaderDescription>
        My academic foundation is strengthened by hands-on development and project-based learning, allowing me to translate theoretical concepts into real-world, scalable tech solutions.
        </PageHeaderDescription>
      </PageHeader>
